...
const LOG_FREQUENCY = 10000; // how often to show logs wrt to iterations
...
class NeuralNetwork{
    ...
    train(inputArray,targetArray){
        ...
        // calculate the output erros ( target - output )
        ...
        // calculate the deltas ( errors * derivative of output)
...
class Matrix{
    constructor(rows, cols,data=[]){
        ...
        // initialise with zeroes if not data provided
    ...
    static dot(m0,m1){
        if(m0.cols != m1.rows){
            throw new Error("Matrices are not \"dot\" product compatible");
        }
